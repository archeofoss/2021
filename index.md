...
- Notification of acceptance of the abstracts of speeches and workshops: **14/07/2021**
...
The first day of the conference will be dedicated to presenting projects and research related to the use of FLOS in Archaeology. The Organising Committee invites proposals for talks, especially, but not limited to, the **younger people of the community** to give voice to new projects and ideas **(freelance developers, graduate or PhD students, research fellows, postdoctoral fellows, etc.)**.
The talks sessions will consist of 10-minute presentations, followed by 5 minutes of questions and answers.
...
### ![icon](./images/icons/trowel.svg "Trowel") TOPIC 1 <br> Use and Application of Free/Libre and Open Source (FLOS) Tools in Archaeology
...
### ![icon](./images/icons/share.svg "Share") TOPIC 2 <br>Creation, Use and Promotion of Open Data and Open Formats in Archaeology
...
### ![icon](./images/icons/gears.svg "Gears") TOPIC 3 <br> Development and Customization of FLOS Software and Hardware Solutions for Cultural Heritage
...
All the submitted abstracts (**talks and workshops**) – together with the author’s short biography, profile picture, affiliation and email address, GitHub/GitLab/etc. link, in digital format. The volume, provided to the authors and participants, will be freely available on the ArcheoFOSS website. Papers will undergo a double-blind peer-review process.

### After the Conference

All the authors will be asked to submit a full paper to be published in the complete version of the proceedings and will gather the publication in a gold OA volume.
The author of the workshops may also submit their papers to include them in the Proceedings. The aim is to create a manual that summarises the topics presented during the 2021 ARCHEOFOSS edition workshops.
